...
frappe.query_reports["Recheck Stock Entry"] = {
	"filters": [
		{
	...
	"formatter":function (row, cell, value, columnDef, dataContext, default_formatter) {
						...
						if (columnDef.id == "TotalValueDifference") {
									  if(dataContext.TotalValueDifference <0){
												  value = "<span style='color:red;font-weight:bold'>" + value + "</span>";
										}else if(dataContext.TotalValueDifference >0){
														value = "<span style='color:green;font-weight:bold'>" + value + "</span>";
										}
						}

						if (columnDef.id == "TotalAdditionalCosts") {
									  if(dataContext.TotalAdditionalCosts <0){
												  value = "<span style='color:red;font-weight:bold'>" + value + "</span>";
										}else if(dataContext.TotalAdditionalCosts >0){
														value = "<span style='color:green;font-weight:bold'>" + value + "</span>";
										}
						}
